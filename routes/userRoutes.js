...
const router = Router();
const {job_board, job_details, view_my_applications, apply_to_job, view_my_bookmarks, create_bookmark, delete_bookmark} = require('../controllers/UserController');
...
router.post('/bookmark/delete/:id', delete_bookmark);
